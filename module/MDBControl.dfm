object ModuleDBControl: TModuleDBControl
  ...
  object QueryRec: TADOQuery
    ...
    object QueryRecnameRecord: TWideStringField
      FieldName = 'nameRecord'
      Size = 255
    end
    object QueryRecrecord: TWideStringField
      FieldName = 'record'
      Size = 255
    end
    object QueryRecidDev: TIntegerField
      FieldName = 'idDev'
    end
    object QueryRecnameDev: TWideStringField
      FieldName = 'nameDev'
      Size = 255
    end
  end
